#!/bin/bash
# Reference: https://medium.com/@leonfeng/set-up-a-secured-mongodb-container-e895807054bd
# Disscusion: https://stackoverflow.com/questions/42912755/how-to-create-a-db-for-mongodb-container-on-start-up
